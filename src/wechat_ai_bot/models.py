...
from wechat_ai_bot.weixin.parser.util.protocbuf.roomdata_pb2 import ChatRoomData
...
class UserInfo:
    ...
    On Linux, most fields are empty/default since we can't read process memory.
    """
    ...
    data_dir: str = ""  # 数据目录
    dbkey: str = ""  # 数据库密钥
    raw_keys: Dict[str, str] = None  # 原始密钥集合
    dat_key: str = ""  # dat文件密钥
    dat_xor_key: int = -1  # dat文件异或密钥
